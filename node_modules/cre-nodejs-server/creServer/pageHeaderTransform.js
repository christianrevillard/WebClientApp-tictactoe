...
var getTransform = function () {
	...
	var builder = new transform({ });
	  ...
	  var commonHeaderFileName =  server.applicationRoot + '/' + server.pageHeader;
  console.log('HeaderFile: ', commonHeaderFileName);
    ...
    console.log('Found HeaderFile: ', commonHeaderFileName);
